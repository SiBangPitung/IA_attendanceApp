package com.example.application.views.clubdashboard;


import com.example.application.views.MainLayout;
import com.example.application.views.clubdashboard.ServiceHealth.Status;
...
@Route(value = "club-dashboard", layout = MainLayout.class)
@RolesAllowed("USER")
public class ClubDashboardView extends Main {

    public ClubDashboardView() {
        addClassName("club-dashboard-view");
